...
export interface ApiVinoVino extends Struct.CollectionTypeSchema {
  collectionName: 'vinos';
  info: {
    displayName: 'vino';
    pluralName: 'vinos';
    singularName: 'vino';
  ...
  attributes: {
    anada: Schema.Attribute.Integer;
    bodega: Schema.Attribute.String;
    cepa: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
